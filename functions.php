    ...
    function akina_setup()
{
        ...
        register_nav_menus(array(
            'primary' => __('Nav Menus', 'akina'), //导航菜单
        ));
...
function sakura_scripts()
{
    if (akina_option('jsdelivr_cdn_test')) {
        ...
        wp_enqueue_script('js_lib', 'https://upyun.rm-rf.fun/sakura/js/lib.min.js', array(), SAKURA_VERSION, true);
    }
    if (akina_option('app_no_jsdelivr_cdn')) {
        ...
        wp_enqueue_style('saukra_css', 'https://upyun.rm-rf.fun/sakura/css/style.min.css', array(), SAKURA_VERSION);
        wp_enqueue_script('app', 'https://upyun.rm-rf.fun/sakura/js/sakura-app.min.js', array(), SAKURA_VERSION, true);
    }
    wp_enqueue_script('github_card', 'https://upyun.rm-rf.fun/sakura/js/widget.js', array(), SAKURA_VERSION, true);
 ...
 *
 * 标准的 lazyload 输出头像
 * <?php echo str_replace( 'src=', 'src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/svg/loader/index.ajax-spinner-preloader.svg" onerror="imgError(this,1)" data-src=', get_avatar( $comment->comment_author_email, '80', '', get_comment_author(), array( 'class' => array( 'lazyload' ) ) ) ); ?>
 *
 * 如果不延时是这样的
			...
			<div class="contents">
				<div class="comment-arrow">
					<div class="main shadow">
						<div class="profile">
							<a href="<?php comment_author_url();?>" target="_blank" rel="nofollow"><?php echo str_replace('src=', 'src="https://upyun.rm-rf.fun/sakura/icon/trans.ajax-spinner-preloader.svg" onerror="imgError(this,1)" data-src=', get_avatar($comment->comment_author_email, '80', '', get_comment_author(), array('class' => array('lazyload')))); ?></a>
						</div>
						<div class="commentinfo">
							<section class="commeta">
								<div class="left">
									<h4 class="author"><a href="<?php comment_author_url();?>" target="_blank" rel="nofollow"><?php echo get_avatar($comment->comment_author_email, '24', '', get_comment_author()); ?><span class="bb-comment isauthor" title="<?php _e('Author', 'akina');?>"><?php _e('Blogger', 'akina'); /*博主*/?></span> <?php comment_author();?> <?php echo get_author_class($comment->comment_author_email, $comment->user_id); ?></a></h4>
								</div>
								<?php comment_reply_link(array_merge($args, array('depth' => $depth, 'max_depth' => $args['max_depth'])));?>
								<div class="right">
									<div class="info"><time datetime="<?php comment_date('Y-m-d');?>"><?php echo poi_time_since(strtotime($comment->comment_date_gmt), true); //comment_date(get_option('date_format'));  ?></time><?php echo siren_get_useragent($comment->comment_agent); ?><?php echo mobile_get_useragent_icon($comment->comment_agent); ?>&nbsp;<?php if(akina_option('open_location')){ _e('Location', 'akina'); /*来自*/?>: <?php echo convertip(get_comment_author_ip());} ?>
    									<?php if (current_user_can('manage_options') and (wp_is_mobile() == false)) {
            $comment_ID = $comment->comment_ID;
            $i_private = get_comment_meta($comment_ID, '_private', true);
            $flag = '';
            $flag .= ' <i class="fa fa-snowflake-o" aria-hidden="true"></i> <a href="javascript:;" data-actionp="set_private" data-idp="' . get_comment_id() . '" id="sp" class="sm" style="color:rgba(0,0,0,.35)">' . __('Private', 'akina') . ': <span class="has_set_private">';
            if (!empty($i_private)) {
                $flag .= __('Yes', 'akina') . ' <i class="fa fa-lock" aria-hidden="true"></i>';
            } else {
...
function get_author_class($comment_author_email, $user_id)
{
    ...
    {
        echo '<span class="showGrade0" title="Lv0"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_0.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 6 && $author_count < 10) {
        echo '<span class="showGrade1" title="Lv1"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_1.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 10 && $author_count < 20) {
        echo '<span class="showGrade2" title="Lv2"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_2.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 20 && $author_count < 40) {
        echo '<span class="showGrade3" title="Lv3"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_3.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 40 && $author_count < 80) {
        echo '<span class="showGrade4" title="Lv4"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_4.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 80 && $author_count < 160) {
        echo '<span class="showGrade5" title="Lv5"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_5.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 160) {
        echo '<span class="showGrade6" title="Lv6"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/level/level_6.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    }
...
function get_post_views($post_id)
{
    if (akina_option('statistics_api') == 'wp_statistics') {
        if (!function_exists('wp_statistics_pages')) {
            return __('Please install pulgin <a href="https://wordpress.org/plugins/wp-statistics/" target="_blank">WP-Statistics</a>', 'akina');
        } else {
    ...
    if (!empty($bookmarks)) {
        ...
        foreach ($bookmarks as $bookmark) {
            if (empty($bookmark->link_description)) {
                $bookmark->link_description = __('This guy is so lazy ╮(╯▽╰)╭', 'akina');
            }
...
{
    //Gravatar地址会变，需要更新，有机会做个配置
    $gravatar_url = array('secure.gravatar.com/avatar','dn-qiniu-avatar.qbox.me/avatar','cdn.v2ex.com/gravatar','gravatar.loli.net/avatar','gravatar.zeruns.tech/avatar');
    ...
    if (($parent_id != '') && ($spam_confirmed != 'spam') && ($admin_notify != '0') && (!$mail_notify)) {
      ...
      box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.18);">
        <header style="overflow: hidden;">
            <img style="width:100%;z-index: 666;" src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/other/head.jpg">
        </header>
      ...
      <div style="text-align: center;">
          <img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/other/hr.png" alt="hr" style="width:100%;
...
';
        ...
        $message = str_replace("{{", '<img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/bili/hd/ic_emoji_', $message);
...
function comment_picture_support($content)
{
    ...
    $content = str_replace('[img]', '<br><img src="https://upyun.rm-rf.fun/sakura/icon/trans.ajax-spinner-preloader.svg" data-src="', $content);
    $content = str_replace('[/img]', '" class="lazyload comment_inline_img" onerror="imgError(this)"><br>', $content);
    $content = str_replace('[/img^img]', '" class="lazyload comment_inline_img" onerror="imgError(this)"><img src="https://upyun.rm-rf.fun/sakura/icon/trans.ajax-spinner-preloader.svg" data-src="', $content);
    return $content;
}
...
{
    return 'https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/smilies/' . $img;
}
...
function push_smilies()
{
    ...
    foreach ($wpsmiliestrans as $k => $v) {
        $Sname = str_replace(":", "", $k);
        $Svalue = $v;
        $return_smiles = $return_smiles . '<span title="' . $Sname . '" onclick="grin(' . "'" . $Sname . "'" . ')"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/Sakura/images/smilies/' . $Svalue . '" /></span>';
    }
...
function push_bili_smilies()
{
    ...
    for ($i = 0; $i < count($name); $i++) {
        ...
        // 选择面版
        $return_smiles = $return_smiles . '<span class="emotion-secter emotion-item emotion-select-parent" onclick="grin(' . "'" . $name[$i] . "'" . ',type = \'Math\')" style="background-image: url(https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/bili/hd/ic_emoji_' . $name[$i] . '.png);"><div class="img emotion-select-child" style="background-image: url(https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/bili/' . $name[$i] . '.png);
        ...
        "></div></span>';
        // 正文转换
        $bilismiliestrans['{{' . $name[$i] . '}}'] = '<span class="emotion-inline emotion-item"><img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/bili/' . $name[$i] . '.png" class="img" style="/*background-image: url();*/
        animation-duration: ' . ($img_height / 32 * 40) . 'ms;
        animation-timing-function: steps(' . ($img_height / 32) . ');
        transform: translateY(-' . ($img_height - 32) . 'px);
        height: ' . $img_height . 'px;
...
{
    $content = str_replace("{{", '<img src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/img/bili/hd/ic_emoji_', $content);
    ...
    if ($comment) {
        if (get_comment_meta($comment->comment_ID, 'new_field_qq', true)) {
            ...
            if (akina_option('qq_avatar_link') == 'off') {
                return '<img src="https://q2.qlogo.cn/headimg_dl?dst_uin=' . $qq_number . '&spec=100" data-src="' . stripslashes($m[1]) . '" class="lazyload avatar avatar-24 photo" title="😀" width="24" height="24" onerror="imgError(this,1)">';
            } elseif (akina_option('qq_avatar_link') == 'type_3') {
                $qqavatar = file_get_contents('http://ptlogin2.qq.com/getface?appid=1006102&imgtype=3&uin=' . $qq_number);
                preg_match('/:\"([^\"]*)\"/i', $qqavatar, $matches);
                return '<img src="' . $matches[1] . '" data-src="' . stripslashes($m[1]) . '" class="lazyload avatar avatar-24 photo" title="😀" width="24" height="24" onerror="imgError(this,1)">';
            } else {
                $iv = str_repeat($sakura_privkey, 2);
                $encrypted = openssl_encrypt($qq_number, 'aes-128-cbc', $sakura_privkey, 0, $iv);
                $encrypted = urlencode(base64_encode($encrypted));
                return '<img src="' . rest_url("sakura/v1/qqinfo/avatar") . '?qq=' . $encrypted . '"class="lazyload avatar avatar-24 photo" title="😀" width="24" height="24" onerror="imgError(this,1)">';
            }
        } else {
            return $avatar;
        }
...
function permalink_tip()
{
    if ( !get_option('permalink_structure') ){
        $msg = __('<b> For a better experience, please do not set <a href="/wp-admin/options-permalink.php"> permalink </a> as plain. To do this, you may need to configure <a href="https://www.wpdaxue.com/wordpress-rewriterule.html" target="_blank"> pseudo-static </a>. </ b>','akina'); /*<b>为了更好的使用体验，请不要将<a href="/wp-admin/options-permalink.php">固定链接</a>设置为朴素。为此，您可能需要配置<a href="https://www.wpdaxue.com/wordpress-rewriterule.html" target="_blank">伪静态</a>。</b>*/
        echo '<div class="notice notice-success is-dismissible" id="scheme-tip"><p><b>' . $msg . '</b></p></div>';
    }
}
