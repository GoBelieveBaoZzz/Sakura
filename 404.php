...
<link type="text/css" media="all" href="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/css/lib.css" rel="stylesheet" />
<?php wp_head(); ?>
<script>
...
<a id="golast" href=javascript:history.go(-1);><?php _e('return to previous page','akina');/*返回上一页*/?></a>
<a id="gohome" href="<?php bloginfo('url');?>"><?php _e('return to home page','akina');/*返回主页*/?></a>
</div>
<div style="display:block; width:284px;margin: auto;">
<p style="margin-bottom: 1em;margin-top: 1.5em;text-align: center;font-size: 15px;"><?php _e('Don\'t worry, search in site?','akina');/*别急，试试站内搜索？*/?></p>
...
<script src="https://cdn.jsdelivr.net/gh/qq1041663097/cdn@1.0.0/js/other/404.min.js" type="text/javascript"></script>
</body>
