...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __('Akina Options', 'akina'),
		'menu_title' => __('Akina Options', 'akina'),
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php _e( 'Save', 'akina' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore default', 'akina' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'All setting will be lost, sure?', 'akina' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
