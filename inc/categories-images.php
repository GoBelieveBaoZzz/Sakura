...
function z_add_texonomy_field() {
	...
	echo '<div class="form-field">
		<label for="taxonomy_image">' . __('category/tag image', 'akina') /*分类/标签图像*/. '</label>
		<input type="text" name="taxonomy_image" id="taxonomy_image" value="" />
		<br/>
		<button class="z_upload_image_button button">' . __('add image', 'akina') /*添加图像*/. '</button>
	</div>'.z_script();
}
...
function z_edit_texonomy_field($taxonomy) {
	...
	echo '<tr class="form-field">
		<th scope="row" valign="top"><label for="taxonomy_image">' .__('category/tag image', 'akina') /*分类/标签图像*/. '</label></th>
		...
		<button class="z_upload_image_button button">' . __('add image', 'akina') /*添加图像*/. '</button>
		<button class="z_remove_image_button button">' . __('remove image', 'akina') /*删除图像*/. '</button>
		</td>
	</tr>'.z_script();
}
...
function z_taxonomy_columns( $columns ) {
	...
	$new_columns['thumb'] = __('image', 'akina')/*图像*/;
...
function z_taxonomy_column( $columns, $column, $id ) {
	if ( $column == 'thumb' )
		$columns = '<span><img src="' . z_taxonomy_image_url($id, 'thumbnail', TRUE) . '" alt="' . __('no image', 'akina') /*暂无*/. '" class="wp-post-image" /></span>';
