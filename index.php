...
?>
   ...
   <?php if ( akina_option('head_notice') != '0'){ 
	...
	<div id="primary" class="content-area">
		...
		<h1 class="main-title" style="font-family: 'Ubuntu', sans-serif;"><i class="fa fa-envira" aria-hidden="true"></i> 文章列表</h1>
		<?php
		if ( have_posts() ) :
		...
		<div id="pagination"><?php next_posts_link('更早的文章'); ?></div>
